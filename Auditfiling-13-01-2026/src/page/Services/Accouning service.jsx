...
//   // Fetch all menus and find accounting menu
//   useEffect(() => {
...
//         // Find accounting-related menu
//         const accountingMenu = menusData.find((menu) => {
//           const name = (menu.name || menu.menu_name || "").toLowerCase();
//           return (
//             name.includes("accounting") ||
//             name.includes("accounting service") ||
//             name.includes("accounting service")
//           );
//         });

//         if (accountingMenu) {
//           setActiveSection("menu-overview");
//           fetchMenuDetail(accountingMenu.id);
//         } else {
//           console.warn("⚠️ No accounting menu found!");
//           setLoading(false);
//         }
//       } catch (err) {
...
//         <div className="text-xl text-gray-600">Loading accounting data...</div>
//       </div>
//     );
//   }
...
//                   Find quick answers to common questions about our accounting services
//                 </p>
//               </div>
...
//             return (
//               <section className="bg-white rounded-xl sm:rounded-2xl shadow-sm p-4 sm:p-6">
//                 <h1 className="text-xl sm:text-2xl lg:text-3xl font-serif font-semibold text-center mb-12 text-gray-900">
...
//                   Choose your accounting service to continue with payment
//                 </p>
...
export default function AccountingService() {
  ...
  // Handle accounting training navigation
  const handleAccountingTrainingClick = () => {
    navigate("/accounting-training");
  };
        ...
        {!isMobile && (
          <nav className={`flex-none ${isTablet ? 'lg:w-55' : 'xl:w-70'} sticky top-24 self-start bg-white rounded-xl ml-15 sm:rounded-2xl p-4 sm:p-6 h-auto border border-gray-100 shadow-sm`}>
            ...
            <ul className="space-y-2 list-none sm:space-y-3">
              ...
              {/* Static Accounting Training Link */}
              <li className="border-t border-gray-100 pt-2 mt-2">
                <button
                  onClick={handleAccountingTrainingClick}
                  className="w-full text-left flex items-start py-2 px-3 rounded-lg transition-all duration-200 text-gray-600 hover:text-blue-600 hover:bg-gray-50"
                >
        ...
        <main className={`flex-1 ${!isMobile ? 'lg:mx-4' : ''}`}>
          ...
          {isMobile && (
            <div className="mt-6">
              ...
              {/* Mobile Accounting Training Link */}
              <div className="mt-4">
                <button
                  onClick={handleAccountingTrainingClick}
                  className="w-full bg-green-50 hover:bg-green-100 text-green-700 font-semibold py-3 px-4 rounded-lg border border-green-200 transition duration-200 flex items-center justify-center"
                >
                  <span className="mr-2">📚</span>
                  Explore Accounting Training
                </button>
              </div>
            </div>
          )}
