...
export default function BankValuation() {
  ...
  // Fetch all menus and find "Bank Valuation"
  useEffect(() => {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-screen">
        <div className="text-xl text-gray-600">Loading Bank Valuation data...</div>
      </div>
    );
  }
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-6 sm:mb-8 lg:mb-10">
                ...
                <p className="text-gray-600 text-sm sm:text-base lg:text-lg max-w-2xl mx-auto">
                  Find quick answers to common questions about our bank valuation services
                </p>
              </div>
