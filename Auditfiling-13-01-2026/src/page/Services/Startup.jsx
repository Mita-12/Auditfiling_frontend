...
export default function StartUp() {
  ...
  // Fetch all menus and find Startup menu
  useEffect(() => {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-screen">
        <div className="text-xl text-gray-600">Loading Startup data...</div>
      </div>
    );
  }
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-6 sm:mb-8 lg:mb-10">
                ...
                <p className="text-gray-600 text-sm sm:text-base lg:text-lg max-w-2xl mx-auto">
                  Find quick answers to common questions about our startup services
                </p>
              </div>
            ...
            <div className="mt-6">
              ...
              <div className="bg-white shadow-sm rounded-2xl mt-4 p-4 w-full border border-gray-100">
                ...
                <p className="text-center text-[15px] mb-3">
                  Choose your Startup service to continue with payment
                </p>
