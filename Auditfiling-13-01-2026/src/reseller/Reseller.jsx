...
export default function ServiceProviderForm() {
  ...
  const sendOtp = async () => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/v1/reseller/custom_otp`, {
        method: "POST",
  ...
  const verifyOtp = async () => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/v1/reseller/custom_otp/store`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/v1/reseller/registration`, {
        method: "POST",
        body: submissionData,
      });
        ...
        Swal.fire({
          ...
          html: `
            <div style="text-align: center;">
              <p style="font-size: 18px; margin-bottom: 20px;">Thank you for registering as a Reseller!</p>
