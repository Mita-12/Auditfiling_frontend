...
const UserFeedback = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_BACKEND_BASE_URL}/api/feedback`, {
                method: 'POST',
                headers: {
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
                <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
                    ...
                    <button
                        onClick={resetForm}
                        className="bg-white  px-6 py-3 rounded-lg  transition duration-200 font-medium"
                    >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="flex justify-center space-x-4">
                                {[1, 2, 3, 4, 5].map((star) => (
                                    <button
                                        ...
                                        className={`p-3 rounded-full transition duration-200 ${formData.rating >= star
                        ...
                        <div className="pt-4">
                            <button
                                type="submit"
                                disabled={loading}
                                className={`w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-3 px-4 rounded-lg focus:ring-offset-2 transition duration-200 font-medium text-lg ${loading
